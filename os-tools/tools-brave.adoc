...
.macs
----
while true; do cat /home/haze/.config/BraveSoftware/brave-browser-experiment/Profile@Experiment/Preferences | jq '.protection.macs.extensions.settings.ghmbeldphafepmbegfdlkpapadhbakde'; sleep 1; done
----